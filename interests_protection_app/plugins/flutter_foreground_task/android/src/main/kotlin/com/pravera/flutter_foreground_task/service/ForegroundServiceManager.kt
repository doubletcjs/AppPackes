...
class ForegroundServiceManager {
    ...
    fun onDetached(): Boolean {
        ...
        if (ForegroundService.backgroundChannel == null) return false

        try {
            ForegroundService.backgroundChannel?.invokeMethod(ForegroundService.ACTION_TASK_DETACHED, null)
        } catch (e: Exception) {
            return false
        }
        return true
    ...
    fun reLaunch(): Boolean {
        ...
        try {
            ForegroundService.backgroundChannel?.invokeMethod(ForegroundService.ACTION_TASK_LAUNCH, null)
        } catch (e: Exception) {
            return false
        }
        return true
