...
class MethodChannelFlutterForegroundTask extends FlutterForegroundTaskPlatform {
  ...
  Future<bool> reLaunch() async {
    return await methodChannel.invokeMethod('reLaunch');
  }

  @override
  Future<bool> onDetached() async {
    return await methodChannel.invokeMethod('onDetached');
  }
  ...
  @override
  Future<bool> get isAppOnBackground async {
    return await methodChannel.invokeMethod('isAppOnBackground');
  }
