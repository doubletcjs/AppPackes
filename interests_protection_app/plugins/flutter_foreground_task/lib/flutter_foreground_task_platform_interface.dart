...
abstract class FlutterForegroundTaskPlatform extends PlatformInterface {
  ...
  Future<bool> reLaunch() {
    throw UnimplementedError('reLaunch() has not been implemented.');
  }

  Future<bool> onDetached() {
    throw UnimplementedError('onDetached() has not been implemented.');
  }
  ...
  Future<bool> get isAppOnBackground {
    throw UnimplementedError('isAppOnBackground has not been implemented.');
  }
