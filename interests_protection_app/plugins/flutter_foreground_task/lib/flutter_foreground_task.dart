...
abstract class TaskHandler {
  ...
  Future<void> onLaunch(DateTime timestamp);
  Future<void> onDetached(DateTime timestamp);
...
class FlutterForegroundTask {
  ...
  static Future<bool> reLaunch() =>
      FlutterForegroundTaskPlatform.instance.reLaunch();
  static Future<bool> onDetached() =>
      FlutterForegroundTaskPlatform.instance.onDetached();
  ...
  static Future<bool> get isAppOnBackground =>
      FlutterForegroundTaskPlatform.instance.isAppOnBackground;
    ...
    backgroundChannel.setMethodCallHandler((call) async {
      ...
      switch (call.method) {
        ...
        case 'onNotificationPressed':
          ...
          break;
        case 'onLaunch':
          handler.onLaunch(timestamp);
          break;
        case 'onDetached':
          handler.onDetached(timestamp);
          break;
      }
    });
