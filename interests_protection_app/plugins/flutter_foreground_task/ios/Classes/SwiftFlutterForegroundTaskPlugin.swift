...
public class SwiftFlutterForegroundTaskPlugin: NSObject, FlutterPlugin {
    ...
    public func detachFromEngine(for registrar: FlutterPluginRegistrar) {
        _ = backgroundServiceManager?.onDetached()
    }
    ...
    private func onMethodCall(call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "reLaunch":
            result(backgroundServiceManager?.reLaunch() ?? false)
        case "restartService":
        ...
        case "isAppOnBackground":
            result(UIApplication.shared.applicationState == .inactive)
        default:
